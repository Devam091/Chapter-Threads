...
<body>
<iframe src="https://publuu.com/flip-book/655291/1461490/page/1?embed" width="100%" height="670" scrolling="no" frameborder="0" allow="clipboard-write; autoplay; fullscreen" class="publuuflip"></iframe>
	<center>
		<br>
    <a href="./Quiz/HP7/index.php"><button class="btns">Attempt Quiz</button></a>
    </center>
</body>
</html>