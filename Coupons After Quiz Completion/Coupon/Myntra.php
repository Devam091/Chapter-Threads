    ...
    <body>
        ...
        <div class="container">
            <div class="coupon-card">
                <img src="https://i.postimg.cc/prVQqnXB/myntra-logo.png" class="logo">
                <h3>Flat Rs.100 on Minimum purchase of Rs.499</h3>
                <di class="coupon-row">
                    <span id="cpnCode">VANEXTRA100</span>
                    <span id="cpnBtn">Copy Code</span>
                </di>
                <p>Valid Till: 01July, 2024</p>
                <div class="circle1"></div>
                <div class="circle2"></div>
                <input type="hidden" name="code" value="VANEXTRA100">
