...
<form action="" method="post">
    <div class="container">
        <div class="coupon-card">
            <img src="https://i.postimg.cc/2y4pFMyW/ajio-logo.png" class="logo">
            <h3>Get 15% off on Rs.1790 and Above...</h3>
            <div class="coupon-row">
                <span id="cpnCode">SAVE15</span>
            ...
            <input type="hidden" name="code" value="SAVE15">
