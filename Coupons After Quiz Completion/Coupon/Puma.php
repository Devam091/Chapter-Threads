    ...
    <body>
        ...
        <div class="container">
            <div class="coupon-card">
                <img src="https://i.postimg.cc/tTV0yj7K/puma-logo.png" class="logo">
                <h3>Avail 40% off on spending Rs.2500 and Above</h3>
                <di class="coupon-row">
                    <span id="cpnCode">PUMAP40</span>
                    <span id="cpnBtn">Copy Code</span>
                </di>
                <p>Valid Till: 01Dec, 2024</p>
                <div class="circle1"></div>
                <div class="circle2"></div>
                <input type="hidden" name="code" value="PUMAP40">
