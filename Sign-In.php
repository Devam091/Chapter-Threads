...
<body>
                                    ...
                                    <div class="card-front" style="height: 500px;">
                                        ...
                                        <div class="section text-center">
                                            <div class="form-group mt-2">
                                                <input type="text" name="signname" class="form-style" placeholder="Your Name" id="signname" autocomplete="on">
    ...
    function validateEmailAndDomain() {
        ...
        const usern = document.getElementById('signname').value;
        ...
        // Validate Username
        if(!validateUser(usern)){
            document.getElementById('username-error').textContent = "Username should not contain special symbols and must be of length max 10 letters.";
            isValid = false;
        }
