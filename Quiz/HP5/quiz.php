    ...
    <section class="main-section">
      <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" data-bs-theme="light">
        <div class="container-fluid">
          <p class="navbar-brand">Harry Potter and the Order of the Phoenix Quiz</p>
          <p id="timer" class="navbar-brand" style="margin-left: 925px;">05:00</p>
      ...
      <form action="checkanswers.php" method="post">
        ...
        $sql = "SELECT * FROM quesans WHERE book_id = 5 ORDER BY RAND() LIMIT 10";
