    ...
    <section class="main-section">
      <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" data-bs-theme="light">
        <div class="container-fluid">
          <p class="navbar-brand">Harry Potter and the Half-Blood Prince Quiz</p>
          <p id="timer" class="navbar-brand" style="margin-left: 955px;">05:00</p>
      ...
      <form action="checkanswers.php" method="post">
        ...
        $sql = "SELECT * FROM quesans WHERE book_id = 6 ORDER BY RAND() LIMIT 10";
