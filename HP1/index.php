...
<body>
  <section class="main-section" style="background-color:var(--seashell);">
    <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="light">
      <div class="container-fluid">
        <p class="navbar-brand" style="font-family: var(--ff-philosopher); font-size:25px;">Harry Potter and the Sorcerer's Stone Quiz</p>
  ...
  if(isset($_SESSION['Email'])){
   echo'<center><button name="answer-submit" class="sub"><a href="quiz.php" id="reatt">Start The Quiz</a></button></center>'; 
  }
  else{
    echo'
    <center><button name="answer-submit" class="sub"><a href="http://localhost:8080/Chapter%20Threads/Login.php" id="reatt">Please Login</a></button></center>';
  }
?>
              </div>
            </div>
