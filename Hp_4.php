...
<body>
<iframe src="https://publuu.com/flip-book/387177/878475/page/1?embed" width="100%" height="680" scrolling="no" frameborder="0" allowfullscreen="" allow="clipboard-write" class="publuuflip"></iframe>
    <center>
    <a href="./Quiz/HP4/index.php"><button class="btns">Attempt Quiz</button></a>
    </center>
</body>
</html>